...
public:
    ...
    public:
        ...
        explicit iterator(T* start) : data(start) {}
        
        iterator(const iterator& obj) : data(obj.data) {}
    ...
    explicit CircleBuffer(size_t capacity) : capacity_Cb(capacity), data(new T[capacity_Cb]) {}
    ...
    void resize(size_t newcapacity_Cb) {
        ...
        size_Cb = std::min(size_Cb, newcapacity_Cb);
